...
(function () {
  ...
  function pintarTarjetas(sesiones) {
    sesiones.forEach((s) => {
      ...
      tarjeta.dataset.tempMinReal = typeof s.temp_min_real === 'number' ? s.temp_min_real.toFixed(1) : '';
      tarjeta.dataset.tempMaxReal = typeof s.temp_max_real === 'number' ? s.temp_max_real.toFixed(1) : '';
